...
const WhyMe = () => {
  ...
  return (
    <div ref={sectionRef} classNameName="bg-[#ECF9F9] py-24 overflow-hidden">
      <ContentWrapper>
        <div classNameName=" ">
          <SectionTitle
            title={"Why Hire Me?"}
          ...
          />
          <div
            classNameName={`flex gap-5 flex-wrap py-4 items-center justify-between w-full h-auto max-md:flex-col max-lg:justify-center max-lg:gap-20 my-8 transition-all duration-1000  ${
