...
const Skills = () => {
  ...
  return (
    <div className=" overflow-hidden" ref={sectionRef}>
      <ContentWrapper>
        <div
          className={`relative w-full h-[220px] max-xl:h-[240px] bg-[#C9D5FF] text-center px-3 py-1 rounded-xl font-[Roboto] max-md:h-[390px] max-sm:mt-10 z-50  transition-all duration-1000 ${
