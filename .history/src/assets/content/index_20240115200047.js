...
import { botwavetech, projectImg } from "../images";
...
export const projectSection = [
  ...
  },
  {
    ...
    site: "movieapp",
    img: projectImg,
    siteLink: "https://movix-eta.vercel.app/",
    gitLing: "https://github.com/jayantatech/MovieApp",
    siteInfo: [
    ...
    description: [
      {
        ...
        secDescription: [
          {
            content:
              "As a film enthusiast turned web developer, I designed a vibrant movie information hub akin to IMDb. This site is a treasure trove, offering in-depth synopses, ratings, and suggestions for similar movies. ",
          },
          {
            content:
      ...
      },
      {
        ...
        secDescription: [
          {
            content:
              "Building this application was a learning curve: mastering advanced routing in React, crafting scalable code structures, and navigating Multipurpose APIs were pivotal lessons. ",
          },
          {
            content:
              "The journey acquainted me with SCSS, unlocking its potent capabilities. ",
          },
          {
            content:
              "From leveraging React's advanced routing to understanding the nuances of scalable code and harnessing SCSS, this project became an immersive learning ground, enriching my development expertise.",
          },
        ],
      },
      {
        ...
        secDescription: [
          {
            content:
              "While constructing this movie app, I encountered diverse challenges: varying API fetching times across locations and hurdles with React Redux.",
          },
          {
            content:
              " Extensive Google searches, coupled with GPT assistance, led to innovative solutions. ",
          },
          {
            content:
              "Adapting to different time zones for API data and resolving React Redux complexities epitomized the journey, refining my problem-solving skills and reinforcing the project's resilience. ",
          },
        ],
      },
    ],
