    ...
    description: [
      ...
      },
      {
        ...
        secDescription: [
          {
            content:
              "Throughout the development process, I encountered several challenges, including managing complex state interactions, optimizing API requests for better performance, and ensuring responsive design across different devices. ",
          },
          {
            content:
