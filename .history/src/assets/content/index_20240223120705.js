    ...
    description: [
      {
        ...
        secDescription: [
          ...
          {
            content:
              "Developed with React, Tailwind CSS, and JavaScript, this application offers a seamless and interactive user experience. Leveraging various npm libraries, including axios for API calls and react-router for navigation, the app ensures efficiency and reliability",
          },
        ],
      },
      {
