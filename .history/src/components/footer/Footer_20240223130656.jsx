      ...
      <ContentWrapper>
        <div className=" flex w-full h-[300px] max-md:h-[460px] py-8 px-4 flex-col max-md:py-2 max-md:px-1">
          <div className="flex w-full h-full max-md:flex-col max-md:items-center max-md:justify-center">
            ...
            <div className="flex w-1/4 h-[130px] max-lg:h-[160px] mx-20 flex-col gap-3 px-3 py-5 bg-white rounded-2xl shadow-slate-50 max-lg:w-4/5 items-center justify-center mt-3 max-md:w-full">
